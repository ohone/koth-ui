...
The factory allows deployment of a new hill.
The factory is currently available on the following chains:
        </Form.Text>
        <h4>
      ...
      <div className="d-grid gap-2">
        <Button
          disabled={reign === undefined || address === undefined}
          onClick={(c) => props.context.createKoth(reign * 60, address!)}
          variant="primary">
                Create
        </Button>
      </div>
